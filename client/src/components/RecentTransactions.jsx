...
const RecentTransactions = () => {
  ...
  return (
    <div className='text-white'>
      <div className="w-96 h-96 rounded-3xl box-border p-4 border-4 whitespace-nowrap overflow-hidden cursor-pointer bg-dark-blue" style={{ transform: 'translateX(72%) '}}>
